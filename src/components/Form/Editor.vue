...
<template>
  <div class="editor-wrapper">
    ...
    <Editor style="height: 700px; overflow-y: hidden" v-model="modelValue" :mode="mode" :defaultConfig="editorConfig"
...
const toolbarConfig = {
  ...
  // }
  // 排除某些菜单
  excludeKeys: ['fontFamily', 'group-video', 'fontSize', 'lineHeight', 'insertImage', 'imageWidth30', 'imageWidth50', 'imageWidth100', 'uploadImage', 'deleteImage', 'editImage', 'fullScreen', 'group-image']
}
