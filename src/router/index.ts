  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'blueprint',
        name: 'Blueprint',
        component: () => import(`@views/dashboard/Blueprint/index.vue`),
        meta: {
          title: '数据看板',
          title_en: 'Databoard',
          keepAlive: false
...
export const roleRoutes: AppRouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      },
      {
        path: '/class/kcb',
        name: 'ClassKCB',
        component: () => import('@views/class/KCB.vue'),
        meta: {
          title: '课程表管理',
          keepAlive: true
        }
      },
      {
        path: '/class/update',
        name: 'Class Update',
        component: () => import('@views/update/Class.vue'),
        meta: {
          title: '班级信息修改',
          notTab: true
        }
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'Attendance Task',
        component: () => import('@views/task/Attendance.vue'),
        meta: {
          title: '考勤汇总',
          keepAlive: true
        }
    ...
    children: [
      {
        path: '/network/upload',
        name: 'Upload',
        component: () => import('@views/network/Upload.vue'),
        meta: {
          title: '文件上传'
        }
      },
      {
        path: '/network/my',
        name: 'My File',
        component: () => import('@views/network/My.vue'),
        meta: {
          title: '我的文件'
        }
      },
      {
        path: '/network/class',
        name: 'Class File',
        component: () => import('@views/network/Class.vue'),
        meta: {
          title: '班级文件',
        }
      },
      {
        ...
        component: () => import('@views/network/File.vue'),
        meta: {
          title: '文件管理'
        }
      },
...
router.beforeEach(async (to, from, next) => {
  ...
  if (!userStore.isLogin && path !== '/login') {
    sessionStorage.setItem("sessionPath", location.href)
    nextTick(() => {
      userStore.logOut()
      next('/login')
    })
