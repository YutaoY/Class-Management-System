...
import 'echarts/lib/component/visualMap'            // 引入 ECharts 颜色
import 'echarts/lib/chart/heatmap'                  // 引入 ECharts 热力图
import 'echarts/lib/component/calendar'             // 引入 ECharts 日历
